...
static void help(const char *progname) {
  ...
  fprintf(stderr,
          "  -T                 send SIGSTOP to all backend processes if one "
          "dies\n");
  fprintf(stderr,
          "  -W NUM             wait NUM seconds to allow attach from a "
          "debugger\n");

  fprintf(stderr, "\nOptions for single-user mode:\n");
  fprintf(stderr,
          "  --single           selects single-user mode (must be first "
          "argument)\n");
  fprintf(stderr,
  ...
  fprintf(stderr,
          "  -j                 do not use newline as interactive query "
          "delimiter\n");
  fprintf(stderr,
  ...
  fprintf(stderr,
          "  --boot             selects bootstrapping mode (must be first "
          "argument)\n");
  fprintf(stderr,
          "  DBNAME             database name (mandatory argument in "
          "bootstrapping mode)\n");
  fprintf(stderr,
          "  -r FILENAME        send stdout and stderr to given file\n");
