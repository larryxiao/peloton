...
YY_BUFFER_STATE core_yy_scan_bytes(yyconst char *bytes, int len,
                                   yyscan_t yyscanner);
...
static yyconst flex_int16_t yy_accept[290] = {
    ...
    0,  55, 55, 0,  0,  28, 28, 0,  0,  80, 78, 1,  1,  69, 49, 69, 78, 68,
    19, 68, 68, 68, 68, 71, 68, 68, 68, 68, 77, 77, 77, 77, 77, 77, 12, 9,
    5,  5,  6,  6,  58, 51, 11, 16, 32, 32, 22, 42, 31, 22, 46, 46, 48, 52,
    54, 53, 53, 54, 54, 24, 27, 26, 26, 27, 27, 35, 36, 35, 1,  69, 67, 43,
    70, 44, 1,  61, 72, 2,  72, 71, 75, 60, 62,

    64, 66, 63, 65, 77, 8,  20, 18, 59, 15, 12, 9,  9,  10, 5,  7,  4,  3,
    58, 57, 11, 16, 16, 17, 32, 22, 22, 30, 23, 38, 39, 37, 37, 38, 31, 46,
    45, 47, 53, 53, 55, 24, 24, 25, 26, 26, 28, 37, 37, 44, 1,  1,  2,  73,
    72, 76, 74, 50, 21, 9,  14, 10, 9,  3,  16, 13, 17, 16, 22, 41, 23, 22,
    39, 37, 37, 40, 47, 53, 55, 24, 25, 24, 26, 28, 37, 37, 9,  9,  9,  9,
    16, 16, 16, 16, 22, 22, 22, 22, 39, 37,

    37, 40, 55, 24, 24, 24, 24, 28, 37, 37, 9,  9,  9,  9,  9,  16, 16, 16,
    16, 16, 22, 22, 22, 22, 22, 37, 37, 55, 24, 24, 24, 24, 24, 28, 37, 37,
    9,  16, 22, 37, 33, 55, 24, 28, 37, 34, 37, 55, 28, 37, 37, 55, 55, 55,
    28, 28, 28, 37, 37, 55, 55, 28, 28, 37, 56, 55, 55, 55, 55, 29, 28, 28,
...
static yyconst flex_int32_t yy_ec[256] = {
    ...
    10, 11, 12, 12, 13, 14, 12, 15, 16, 17, 18, 18, 18, 18, 18, 18, 18, 18, 19,
    19, 20, 12, 21, 22, 23, 7,  7,  24, 25, 26, 27, 28, 27, 29, 29, 29, 29, 29,
    29, 29, 30, 29, 31, 29, 29, 32, 29, 33, 29, 29, 34, 29, 29, 12, 35, 12, 9,
    29, 7,  24, 25, 26, 27,

    28, 27, 29, 29, 29, 29, 29, 29, 29, 30, 29, 31, 29, 29, 32, 29, 36, 29, 29,
    37, 29, 29, 1,  7,  1,  7,  1,  29, 29, 29, 29, 29, 29, 29, 29, 29, 29, 29,
...
static yyconst flex_int32_t yy_meta[38] = {
    0, 1, 1, 2, 2, 3, 4, 3, 5, 3, 3,  6,  1,  7,  3,  3,  1,  7,  8,
    8, 1, 3, 3, 3, 9, 9, 9, 9, 9, 10, 10, 10, 10, 10, 10, 11, 10, 10};

static yyconst flex_int16_t yy_base[357] = {
    0,    0,    0,    404,  403,  33,   52,   395,  394,  376,  375,  41,
    42,   362,  361,  55,   75,   353,  352,  82,   117,  334,  333,  152,
    187,  36,   46,   331,  1164, 85,   88,   308,  1164, 0,    85,   0,
    1164, 1164, 310,  80,   311,  89,   48,   57,   300,  295,  0,    305,
    300,  299,  299,  292,  0,    98,   0,    0,    47,   289,  0,    291,
    0,    107,  0,    0,    122,  94,   0,    132,  0,    0,    288,  289,
    1164, 136,  142,  268,  251,  155,  1164, 158,  161,  260,  245,  1164,
    1164, 115,  169,  0,    0,    1164, 76,   262,  219,  1164, 150,  0,
    158,  164,  179,  1164, 1164,

    0,    0,    0,    0,    0,    1164, 1164, 1164, 117,  1164, 0,    197,
    202,  250,  0,    162,  1164, 0,    0,    1164, 0,    206,  235,  249,
    0,    212,  241,  1164, 242,  1164, 233,  0,    0,    0,    0,    0,
    1164, 227,  245,  0,    199,  251,  256,  215,  259,  0,    193,  0,
    0,    214,  0,    267,  0,    1164, 250,  123,  177,  1164, 1164, 283,
    1164, 204,  289,  0,    297,  1164, 203,  303,  311,  1164, 196,  317,
    189,  0,    0,    0,    195,  0,    161,  325,  169,  331,  0,    155,
    0,    0,    335,  339,  345,  349,  353,  359,  363,  367,  373,  377,
    381,  387,  1164, 0,

    0,    1164, 128,  391,  395,  401,  405,  125,  0,    0,    409,  415,
    423,  429,  433,  437,  443,  451,  457,  461,  465,  471,  479,  485,
    489,  0,    0,    98,   493,  499,  507,  513,  517,  85,   0,    0,
    521,  527,  531,  0,    1164, 86,   535,  78,   0,    1164, 0,    541,
    551,  0,    0,    556,  0,    67,   561,  0,    57,   0,    0,    40,
    566,  30,   571,  0,    1164, 576,  581,  586,  591,  1164, 596,  601,
    606,  611,  616,  621,  626,  631,  636,  641,  646,  651,  656,  661,
    666,  0,    671,  0,    1164, 686,  697,  708,  719,  730,  741,  752,
    763,  774,  785,  794,

    797,  803,  813,  824,  835,  846,  857,  867,  878,  889,  896,  902,
    912,  921,  926,  926,  928,  930,  935,  945,  956,  960,  962,  971,
    982,  993,  997,  999,  1001, 1010, 1014, 1016, 1025, 1036, 1047, 1051,
    1053, 1062, 1066, 1068, 1070, 1072, 1074, 1076, 1078, 1080, 1082, 1084,
    1086, 1095, 1106, 1110, 1119, 1130, 1141, 1152};

static yyconst flex_int16_t yy_def[357] = {
    0,   289, 1,   290, 290, 291, 291, 292, 292, 293, 293, 294, 294, 295, 295,
    296, 296, 292, 292, 297, 297, 295, 295, 298, 298, 299, 299, 289, 289, 289,
    289, 300, 289, 300, 301, 300, 289, 289, 300, 289, 300, 289, 289, 300, 300,
    300, 302, 302, 302, 302, 302, 302, 303, 289, 304, 304, 289, 289, 305, 289,
    306, 289, 307, 307, 289, 308, 309, 289, 310, 310, 311, 289, 289, 289, 289,
    289, 289, 289, 289, 289, 289, 289, 289, 289, 289, 289, 289, 300, 300, 289,
    289, 312, 313, 289, 289, 314, 289, 289, 289, 289, 289,

    300, 300, 300, 300, 302, 289, 289, 289, 289, 289, 303, 289, 289, 289, 304,
    289, 289, 315, 305, 289, 306, 289, 289, 289, 307, 289, 289, 289, 289, 289,
    289, 316, 317, 318, 309, 310, 289, 319, 289, 320, 289, 289, 289, 289, 289,
    321, 289, 322, 323, 312, 313, 313, 314, 289, 289, 289, 289, 289, 289, 289,
    289, 289, 324, 315, 289, 289, 289, 325, 289, 289, 289, 326, 289, 327, 328,
    329, 319, 320, 289, 289, 289, 330, 321, 289, 331, 332, 333, 324, 324, 324,
    334, 325, 325, 325, 335, 326, 326, 326, 289, 336,

    337, 289, 289, 338, 330, 330, 330, 289, 339, 340, 333, 333, 289, 333, 324,
    334, 334, 289, 334, 325, 335, 335, 289, 335, 326, 341, 342, 289, 338, 338,
    289, 338, 330, 289, 343, 344, 333, 334, 335, 345, 289, 289, 338, 289, 346,
    205, 205, 205, 205, 205, 205, 209, 209, 210, 210, 211, 211, 211, 211, 211,
    211, 211, 211, 211, 211, 211, 216, 216, 216, 216, 216, 216, 216, 216, 216,
    216, 216, 221, 221, 221, 221, 221, 221, 221, 221, 221, 221, 221, 226, 226,
    227, 227, 229, 229, 229, 229, 229, 229, 229, 229, 229, 229, 229, 235, 235,
    236, 236, 240, 240, 241, 241, 245, 245, 246, 246, 247, 247, 250, 250, 251,
    251, 258, 258, 259, 259, 260, 260, 260, 260, 260,

    289, 260, 260, 260, 260, 260, 262, 262, 262, 262, 262, 289, 262, 262, 262,
    262, 262, 264, 264, 266, 266, 266, 266, 266, 266, 266, 266, 266, 266, 266,
    271, 271, 271, 271, 271, 271, 271, 271, 271, 271, 271, 275, 275, 275, 275,
    275, 275, 275, 275, 275, 275, 275, 280, 280, 280, 280, 280, 280, 280, 280,
    280, 280, 280, 27,  289, 289, 289, 289, 289, 289, 289, 289, 289, 289, 289,
    289, 289, 289, 289, 289, 289, 289, 289, 289, 289, 289, 289, 289, 289, 289,
    289, 289, 289, 289, 289, 289, 289, 289, 289, 289,
...
static yyconst flex_int16_t yy_chk[1202] = {
    ...
    1,   1,   1,   1,   1,   1,   1,   1,   5,   25,  5,   262, 5,   5,   11,
    12,  5,   5,   5,   26,  5,   260, 11,  12,  5,   5,   5,   6,   15,  6,
    56,  6,   6,   15,  56,  6,   6,   6,   42,  6,   42,  25,  257, 6,   6,
    6,   11,  12,  16,  43,  43,  26,  254, 16,  19,  19,  19,  29,  29,  29,
    30,  30,  30,  34,  90,  90,  39,  19,  39,  39,  53,

    53,  53,  34,  34,  41,  244, 41,  41,  61,  61,  61,  65,  53,  242, 19,
    234, 41,  19,  20,  20,  20,  61,  109, 64,  64,  64,  65,  109, 228, 65,
    65,  20,  64,  67,  67,  67,  64,  73,  73,  73,  156, 156, 67,  74,  74,
    74,  67,  85,  208, 20,  85,  203, 20,  23,  23,  23,  77,  77,  77,  79,
    79,  79,  80,  80,  80,  77,  23,  94,  94,  77,  86,  86,  86,  96,  116,
    96,  96,  94,  116, 97,  184, 97,  97,  181, 23,  96,  179, 23,  24,  24,
    24,  97,  98,  98,  157, 157, 98,  98,  112, 112,

    112, 24,  177, 113, 113, 113, 173, 122, 122, 122, 171, 112, 113, 126, 126,
    126, 113, 167, 162, 24,  122, 150, 24,  92,  147, 92,  126, 92,  92,  144,
    141, 92,  92,  92,  138, 92,  123, 123, 123, 92,  92,  92,  127, 127, 127,
    123, 139, 139, 139, 123, 131, 127, 142, 142, 142, 127, 129, 143, 143, 143,
    145, 145, 145, 124, 114, 142, 143, 155, 155, 91,  143, 152, 82,  152, 81,
    152, 152, 155, 76,  152, 152, 152, 75,  152, 160, 160, 160, 152, 152, 152,
    163, 163, 163, 160, 71,  70,  59,  160, 165, 165,

    165, 57,  51,  163, 168, 168, 168, 165, 50,  49,  48,  165, 169, 169, 169,
    47,  45,  168, 172, 172, 172, 169, 44,  40,  38,  169, 180, 180, 180, 31,
    27,  172, 182, 182, 182, 180, 187, 187, 187, 180, 188, 188, 188, 22,  21,
    182, 189, 189, 189, 187, 190, 190, 190, 188, 191, 191, 191, 18,  17,  189,
    192, 192, 192, 190, 193, 193, 193, 191, 194, 194, 194, 14,  13,  192, 195,
    195, 195, 193, 196, 196, 196, 194, 197, 197, 197, 10,  9,   195, 198, 198,
    198, 196, 204, 204, 204, 197, 205, 205, 205, 8,

    320, 0,   320, 320, 320, 320, 320, 320, 320, 320, 320, 321, 0,   321, 321,
    321, 321, 321, 321, 321, 321, 321, 322, 322, 323, 323, 324, 324, 324, 324,
    324, 324, 324, 324, 324, 324, 324, 325, 325, 325, 325, 325, 325, 325, 325,
    325, 325, 325, 326, 326, 326, 326, 326, 326, 326,

    326, 326, 326, 326, 327, 327, 328, 328, 329, 329, 330, 330, 330, 330, 330,
    330, 330, 330, 330, 330, 330, 331, 331, 332, 332, 333, 333, 333, 333, 333,
    333, 333, 333, 333, 333, 333, 334, 334, 334, 334, 334, 334, 334, 334, 334,
    334, 334, 335, 335, 335, 335, 335, 335, 335, 335, 335, 335, 335, 336, 336,
    337, 337, 338, 338, 338, 338, 338, 338, 338, 338, 338, 338, 338, 339, 339,
    340, 340, 341, 341, 342, 342, 343, 343, 344, 344, 345, 345, 346, 346, 347,
    347, 348, 348, 349, 349, 350, 350, 350, 350, 350,

    0,   350, 350, 350, 350, 350, 351, 351, 351, 351, 351, 0,   351, 351, 351,
    351, 351, 352, 352, 353, 353, 353, 353, 353, 353, 353, 353, 353, 353, 353,
    354, 354, 354, 354, 354, 354, 354, 354, 354, 354, 354, 355, 355, 355, 355,
    355, 355, 355, 355, 355, 355, 355, 356, 356, 356, 356, 356, 356, 356, 356,
    356, 356, 356, 289, 289, 289, 289, 289, 289, 289, 289, 289, 289, 289, 289,
    289, 289, 289, 289, 289, 289, 289, 289, 289, 289, 289, 289, 289, 289, 289,
    289, 289, 289, 289, 289, 289, 289, 289, 289, 289,
  ...
  yy_match:
    do {
      ...
      while (yy_chk[yy_base[yy_current_state] + yy_c] != yy_current_state) {
        ...
        if (yy_current_state >= 290) yy_c = yy_meta[(unsigned int)yy_c];
      }
            ...
            if (yyextra->backslash_quote == BACKSLASH_QUOTE_OFF ||
              ...
              ereport(ERROR,
                      (errcode(ERRCODE_NONSTANDARD_USE_OF_ESCAPE_CHARACTER),
                       ...
                       errhint(
                           "Use '' to write quotes in strings. \\' is insecure "
                           "in client-only encodings."),
                       lexer_errposition()));
          }
...
#line 743 "../../src/postgres/backend/parser/scan.lpp"
      {
        ...
        if (identlen >= NAMEDATALEN) truncate_identifier(ident, identlen, true);
        yylval->str = ident;
        return IDENT;
      }
        YY_BREAK
...
#line 848 "../../src/postgres/backend/parser/scan.lpp"
        {
          ...
          if (slashstar && dashdash) {
            ...
            slashstar = dashdash;
          if (slashstar) nchars = slashstar - yytext;
           ...
           */
          if (nchars >= NAMEDATALEN) yyerror("operator too long");
    ...
    if (yyg->yy_c_buf_p < &YY_CURRENT_BUFFER_LVALUE->yy_ch_buf[yyg->yy_n_chars])
      ...
      *yyg->yy_c_buf_p = '\0';
      ...
      switch (yy_get_next_buffer(yyscanner)) {
        ...
        case EOB_ACT_END_OF_FILE: {
          if (core_yywrap(yyscanner)) return EOF;
 ...
 * @return the newly allocated buffer state object.
 */
YY_BUFFER_STATE core_yy_scan_bytes(yyconst char *yybytes, int _yybytes_len,
                                   yyscan_t yyscanner) {
  YY_BUFFER_STATE b;
  char *buf;
  yy_size_t n;
...
static void check_unicode_value(pg_wchar c, char *loc,
                                core_yyscan_t yyscanner) {
  if (GetDatabaseEncoding() == PG_UTF8) return;
...
static void check_string_escape_warning(unsigned char ychar,
  ...
  if (ychar == '\'') {
    if (yyextra->warn_on_first_escape && yyextra->escape_string_warning)
      ereport(WARNING, (errcode(ERRCODE_NONSTANDARD_USE_OF_ESCAPE_CHARACTER),
                        errmsg("nonstandard use of \\' in a string literal"),
                        errhint(
                            "Use '' to write quotes in strings, or use the "
