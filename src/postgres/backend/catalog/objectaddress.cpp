...
static const ObjectPropertyType ObjectProperty[] = {
    {CastRelationId, CastOidIndexId, -1, -1, InvalidAttrNumber,
     InvalidAttrNumber, InvalidAttrNumber, InvalidAttrNumber,
     static_cast<AclObjectKind>(-1), false},
    {CollationRelationId, CollationOidIndexId, COLLOID,
     -1, /* COLLNAMEENCNSP also takes encoding */
     Anum_pg_collation_collname, Anum_pg_collation_collnamespace,
     Anum_pg_collation_collowner, InvalidAttrNumber, ACL_KIND_COLLATION, true},
    {ConstraintRelationId, ConstraintOidIndexId, CONSTROID, -1,
     Anum_pg_constraint_conname, Anum_pg_constraint_connamespace,
     InvalidAttrNumber, InvalidAttrNumber, static_cast<AclObjectKind>(-1),
     false},
    {ConversionRelationId, ConversionOidIndexId, CONVOID, CONNAMENSP,
     Anum_pg_conversion_conname, Anum_pg_conversion_connamespace,
     Anum_pg_conversion_conowner, InvalidAttrNumber, ACL_KIND_CONVERSION, true},
    {DatabaseRelationId, DatabaseOidIndexId, DATABASEOID, -1,
     Anum_pg_database_datname, InvalidAttrNumber, Anum_pg_database_datdba,
     Anum_pg_database_datacl, ACL_KIND_DATABASE, true},
    {ExtensionRelationId, ExtensionOidIndexId, -1, -1,
     Anum_pg_extension_extname,
     InvalidAttrNumber, /* extension doesn't belong to extnamespace */
     Anum_pg_extension_extowner, InvalidAttrNumber, ACL_KIND_EXTENSION, true},
    {ForeignDataWrapperRelationId, ForeignDataWrapperOidIndexId,
     FOREIGNDATAWRAPPEROID, FOREIGNDATAWRAPPERNAME,
     Anum_pg_foreign_data_wrapper_fdwname, InvalidAttrNumber,
     Anum_pg_foreign_data_wrapper_fdwowner, Anum_pg_foreign_data_wrapper_fdwacl,
     ACL_KIND_FDW, true},
    {ForeignServerRelationId, ForeignServerOidIndexId, FOREIGNSERVEROID,
     FOREIGNSERVERNAME, Anum_pg_foreign_server_srvname, InvalidAttrNumber,
     Anum_pg_foreign_server_srvowner, Anum_pg_foreign_server_srvacl,
     ACL_KIND_FOREIGN_SERVER, true},
    {ProcedureRelationId, ProcedureOidIndexId, PROCOID,
     -1, /* PROCNAMEARGSNSP also takes argument types */
     Anum_pg_proc_proname, Anum_pg_proc_pronamespace, Anum_pg_proc_proowner,
     Anum_pg_proc_proacl, ACL_KIND_PROC, false},
    {LanguageRelationId, LanguageOidIndexId, LANGOID, LANGNAME,
     Anum_pg_language_lanname, InvalidAttrNumber, Anum_pg_language_lanowner,
     Anum_pg_language_lanacl, ACL_KIND_LANGUAGE, true},
    {LargeObjectMetadataRelationId, LargeObjectMetadataOidIndexId, -1, -1,
     InvalidAttrNumber, InvalidAttrNumber,
     Anum_pg_largeobject_metadata_lomowner, Anum_pg_largeobject_metadata_lomacl,
     ACL_KIND_LARGEOBJECT, false},
    {OperatorClassRelationId, OpclassOidIndexId, CLAOID,
     -1, /* CLAAMNAMENSP also takes opcmethod */
     Anum_pg_opclass_opcname, Anum_pg_opclass_opcnamespace,
     Anum_pg_opclass_opcowner, InvalidAttrNumber, ACL_KIND_OPCLASS, true},
    {OperatorRelationId, OperatorOidIndexId, OPEROID,
     -1, /* OPERNAMENSP also takes left and right type */
     Anum_pg_operator_oprname, Anum_pg_operator_oprnamespace,
     Anum_pg_operator_oprowner, InvalidAttrNumber, ACL_KIND_OPER, false},
    {OperatorFamilyRelationId, OpfamilyOidIndexId, OPFAMILYOID,
     -1, /* OPFAMILYAMNAMENSP also takes opfmethod */
     Anum_pg_opfamily_opfname, Anum_pg_opfamily_opfnamespace,
     Anum_pg_opfamily_opfowner, InvalidAttrNumber, ACL_KIND_OPFAMILY, true},
    {AuthIdRelationId, AuthIdOidIndexId, AUTHOID, AUTHNAME,
     Anum_pg_authid_rolname, InvalidAttrNumber, InvalidAttrNumber,
     InvalidAttrNumber, static_cast<AclObjectKind>(-1), true},
    {RewriteRelationId, RewriteOidIndexId, -1, -1, Anum_pg_rewrite_rulename,
     InvalidAttrNumber, InvalidAttrNumber, InvalidAttrNumber,
     static_cast<AclObjectKind>(-1), false},
    {NamespaceRelationId, NamespaceOidIndexId, NAMESPACEOID, NAMESPACENAME,
     Anum_pg_namespace_nspname, InvalidAttrNumber, Anum_pg_namespace_nspowner,
     Anum_pg_namespace_nspacl, ACL_KIND_NAMESPACE, true},
    {RelationRelationId, ClassOidIndexId, RELOID, RELNAMENSP,
     Anum_pg_class_relname, Anum_pg_class_relnamespace, Anum_pg_class_relowner,
     Anum_pg_class_relacl, ACL_KIND_CLASS, true},
    {TableSpaceRelationId, TablespaceOidIndexId, TABLESPACEOID, -1,
     Anum_pg_tablespace_spcname, InvalidAttrNumber, Anum_pg_tablespace_spcowner,
     Anum_pg_tablespace_spcacl, ACL_KIND_TABLESPACE, true},
    {TransformRelationId, TransformOidIndexId, TRFOID, InvalidAttrNumber},
    {TriggerRelationId, TriggerOidIndexId, -1, -1, Anum_pg_trigger_tgname,
     InvalidAttrNumber, InvalidAttrNumber, InvalidAttrNumber,
     static_cast<AclObjectKind>(-1), false},
    {PolicyRelationId, PolicyOidIndexId, -1, -1, Anum_pg_policy_polname,
     InvalidAttrNumber, InvalidAttrNumber, InvalidAttrNumber,
     static_cast<AclObjectKind>(-1), false},
    {EventTriggerRelationId, EventTriggerOidIndexId, EVENTTRIGGEROID,
     EVENTTRIGGERNAME, Anum_pg_event_trigger_evtname, InvalidAttrNumber,
     Anum_pg_event_trigger_evtowner, InvalidAttrNumber, ACL_KIND_EVENT_TRIGGER,
     true},
    {TSConfigRelationId, TSConfigOidIndexId, TSCONFIGOID, TSCONFIGNAMENSP,
     Anum_pg_ts_config_cfgname, Anum_pg_ts_config_cfgnamespace,
     Anum_pg_ts_config_cfgowner, InvalidAttrNumber, ACL_KIND_TSCONFIGURATION,
     true},
    {TSDictionaryRelationId, TSDictionaryOidIndexId, TSDICTOID, TSDICTNAMENSP,
     Anum_pg_ts_dict_dictname, Anum_pg_ts_dict_dictnamespace,
     Anum_pg_ts_dict_dictowner, InvalidAttrNumber, ACL_KIND_TSDICTIONARY, true},
    {TSParserRelationId, TSParserOidIndexId, TSPARSEROID, TSPARSERNAMENSP,
     Anum_pg_ts_parser_prsname, Anum_pg_ts_parser_prsnamespace,
     InvalidAttrNumber, InvalidAttrNumber, static_cast<AclObjectKind>(-1),
     true},
    {
     TSTemplateRelationId, TSTemplateOidIndexId, TSTEMPLATEOID,
     TSTEMPLATENAMENSP, Anum_pg_ts_template_tmplname,
     Anum_pg_ts_template_tmplnamespace, InvalidAttrNumber, InvalidAttrNumber,
     static_cast<AclObjectKind>(-1), true,
    },
    {TypeRelationId, TypeOidIndexId, TYPEOID, TYPENAMENSP, Anum_pg_type_typname,
     Anum_pg_type_typnamespace, Anum_pg_type_typowner, Anum_pg_type_typacl,
     ACL_KIND_TYPE, true}};
  ...
  for (;;) {
    ...
    switch (objtype) {
      ...
      case OBJECT_FOREIGN_TABLE:
        address = get_relation_by_qualified_name(objtype, objname, &relation,
                                                 lockmode, missing_ok);
        break;
      case OBJECT_COLUMN:
        address = get_object_address_attribute(objtype, objname, &relation,
                                               lockmode, missing_ok);
        break;
      case OBJECT_DEFAULT:
        address = get_object_address_attrdef(objtype, objname, &relation,
                                             lockmode, missing_ok);
        break;
      case OBJECT_RULE:
      case OBJECT_TRIGGER:
      ...
      case OBJECT_DOMCONSTRAINT: {
        ...
        domaddr = get_object_address_type(OBJECT_DOMAIN, list_head(objname),
                                          missing_ok);
        constrname = strVal(linitial(objargs));

        address.classId = ConstraintRelationId;
        address.objectId =
            get_domain_constraint_oid(domaddr.objectId, constrname, missing_ok);
      ...
      case OBJECT_DOMAIN:
        address =
            get_object_address_type(objtype, list_head(objname), missing_ok);
        break;
      ...
      case OBJECT_OPERATOR:
        ...
        address.objectId = LookupOperNameTypeNames(
            NULL, objname, (TypeName *)linitial(objargs),
            (TypeName *)lsecond(objargs), missing_ok, -1);
        address.objectSubId = 0;
        break;
      ...
      case OBJECT_AMOP:
      case OBJECT_AMPROC:
        address = get_object_address_opf_member(objtype, objname, objargs,
                                                missing_ok);
        break;
      ...
      case OBJECT_USER_MAPPING:
        address = get_object_address_usermapping(objname, objargs, missing_ok);
        break;
      case OBJECT_DEFACL:
        address = get_object_address_defacl(objname, objargs, missing_ok);
        break;
      default:
    ...
    if (OidIsValid(old_address.classId)) {
      ...
      if (old_address.classId != RelationRelationId) {
        if (IsSharedRelation(old_address.classId))
          UnlockSharedObject(old_address.classId, old_address.objectId, 0,
                             lockmode);
        else
          UnlockDatabaseObject(old_address.classId, old_address.objectId, 0,
                               lockmode);
      }
    }
     ...
     */
    if (inval_count == SharedInvalidMessageCounter || relation != NULL) break;
    old_address = address;
  }
  ...
  if (nnames < 2) {
    ...
    switch (objtype) {
      ...
      case OBJECT_TABCONSTRAINT:
        address.classId = ConstraintRelationId;
        address.objectId =
            relation ? get_relation_constraint_oid(reloid, depname, missing_ok)
                     : InvalidOid;
        address.objectSubId = 0;
        break;
      case OBJECT_POLICY:
        ...
        address.objectId =
            relation ? get_relation_policy_oid(reloid, depname, missing_ok)
                     : InvalidOid;
        address.objectSubId = 0;
        break;
      default:
...
static ObjectAddress get_object_address_attrdef(ObjectType objtype,
  ...
  if (!OidIsValid(defoid)) {
    if (!missing_ok)
      ereport(ERROR, (errcode(ERRCODE_UNDEFINED_COLUMN),
                      errmsg(
                          "default value for column \"%s\" of relation \"%s\" "
                          "does not exist",
                          attname, NameListToString(relname))));
...
static ObjectAddress get_object_address_opf_member(ObjectType objtype,
  ...
  switch (objtype) {
    case OBJECT_AMOP: {
      ...
      tp = SearchSysCache4(AMOPSTRATEGY, ObjectIdGetDatum(famaddr.objectId),
    ...
    case OBJECT_AMPROC: {
      ...
      tp = SearchSysCache4(AMPROCNUM, ObjectIdGetDatum(famaddr.objectId),
                           ObjectIdGetDatum(typeoids[0]),
                           ObjectIdGetDatum(typeoids[1]),
                           Int16GetDatum(membernum));
      if (!HeapTupleIsValid(tp)) {
...
static ObjectAddress get_object_address_usermapping(List *objname,
      ...
      if (!missing_ok)
        ereport(
            ...
            (errcode(ERRCODE_UNDEFINED_OBJECT),
             errmsg(
                 "user mapping for user \"%s\" in server \"%s\" does not exist",
                 username, servername)));
      return address;
    }
  ...
  tp = SearchSysCache2(USERMAPPINGUSERSERVER, ObjectIdGetDatum(userid),
...
static ObjectAddress get_object_address_defacl(List *objname, List *objargs,
   ...
   */
  tp = SearchSysCache1(AUTHNAME, CStringGetDatum(username));
  if (!HeapTupleIsValid(tp)) goto not_found;
  userid = HeapTupleGetOid(tp);
  ReleaseSysCache(tp);
  ...
  if (schema) {
    ...
    if (schemaid == InvalidOid) goto not_found;
  } else
    schemaid = InvalidOid;

  /* Finally, look up the pg_default_acl object */
  tp = SearchSysCache3(DEFACLROLENSPOBJ, ObjectIdGetDatum(userid),
                       ObjectIdGetDatum(schemaid), CharGetDatum(objtype));
  if (!HeapTupleIsValid(tp)) goto not_found;
...
not_found:
  if (!missing_ok) {
    if (schema)
      ereport(ERROR, (errcode(ERRCODE_UNDEFINED_OBJECT),
                      errmsg(
                          "default ACL for user \"%s\" in schema \"%s\" on %s "
                          "does not exist",
...
Datum pg_get_object_address(PG_FUNCTION_ARGS) {
  ...
  if (type == OBJECT_TYPE || type == OBJECT_DOMAIN || type == OBJECT_CAST ||
    ...
    deconstruct_array(namearr, TEXTOID, -1, false, 'i', &elems, &nulls,
                      &nelems);
    if (nelems != 1)
      ereport(ERROR, (errcode(ERRCODE_INVALID_PARAMETER_VALUE),
   ...
   */
  if (type == OBJECT_AGGREGATE || type == OBJECT_FUNCTION ||
      type == OBJECT_OPERATOR || type == OBJECT_CAST || type == OBJECT_AMOP ||
      type == OBJECT_AMPROC) {
    ...
    deconstruct_array(argsarr, TEXTOID, -1, false, 'i', &elems, &nulls,
                      &nelems);
  ...
  addr =
      get_object_address(type, name, args, &relation, AccessShareLock, false);

  /* We don't need the relcache entry, thank you very much */
  if (relation) relation_close(relation, AccessShareLock);
 ...
 */
void check_object_ownership(Oid roleid, ObjectType objtype,
                            ObjectAddress address, List *objname, List *objargs,
                            Relation relation) {
  switch (objtype) {
    case OBJECT_INDEX:
    case OBJECT_SEQUENCE:
...
Oid get_object_namespace(const ObjectAddress *address) {
  ...
  if (property->attnum_namespace == InvalidAttrNumber) return InvalidOid;
  ...
  if (!HeapTupleIsValid(tuple))
    elog(ERROR, "cache lookup failed for cache %d oid %u", cache,
         address->objectId);
  oid = DatumGetObjectId(
      SysCacheGetAttr(cache, tuple, property->attnum_namespace, &isnull));
  Assert(!isnull);
...
bool is_objectclass_supported(Oid class_id) {
  ...
  for (index = 0; index < lengthof(ObjectProperty); index++) {
    if (ObjectProperty[index].class_oid == class_id) return true;
  }
...
static const ObjectPropertyType *get_object_property_data(Oid class_id) {
  ...
  ereport(ERROR, (errmsg_internal("unrecognized class___ ID: %u", class_id)));
  ...
  switch (getObjectClass(object)) {
    case OCLASS_CLASS:
      ...
      if (object->objectSubId != 0)
        appendStringInfo(
            &buffer, _(" column %s"),
            get_relid_attribute_name(object->objectId, object->objectSubId));
      break;
    ...
    case OCLASS_CAST: {
      ...
      rcscan =
          systable_beginscan(castDesc, CastOidIndexId, true, NULL, 1, skey);
    ...
    case OCLASS_DEFAULT: {
      ...
      adscan = systable_beginscan(attrdefDesc, AttrDefaultOidIndexId, true,
                                  NULL, 1, skey);
    ...
    case OCLASS_OPCLASS: {
      ...
      appendStringInfo(
          &buffer, _("operator___ class___ %s for access method %s"),
    ...
    case OCLASS_AMOP: {
      ...
      amscan = systable_beginscan(amopDesc, AccessMethodOperatorOidIndexId,
                                  true, NULL, 1, skey);
      ...
      appendStringInfo(&buffer, _("operator___ %d (%s, %s) of %s: %s"),
                       ...
                       format_type_be(amopForm->amoprighttype), opfam.data,
    ...
    case OCLASS_AMPROC: {
      ...
      amscan = systable_beginscan(amprocDesc, AccessMethodProcedureOidIndexId,
                                  true, NULL, 1, skey);
      ...
      appendStringInfo(&buffer, _("function %d (%s, %s) of %s: %s"),
                       ...
                       format_type_be(amprocForm->amprocrighttype), opfam.data,
    ...
    case OCLASS_REWRITE: {
      ...
      rcscan =
          systable_beginscan(ruleDesc, RewriteOidIndexId, true, NULL, 1, skey);
    ...
    case OCLASS_TRIGGER: {
      ...
      tgscan =
          systable_beginscan(trigDesc, TriggerOidIndexId, true, NULL, 1, skey);
    ...
    case OCLASS_TSTEMPLATE: {
      ...
      if (!HeapTupleIsValid(tup))
        elog(ERROR, "cache lookup failed for text search ctemplate %u",
             object->objectId);
      appendStringInfo(
          &buffer, _("text search ctemplate %s"),
    ...
    case OCLASS_DEFACL: {
      ...
      rcscan = systable_beginscan(defaclrel, DefaultAclOidIndexId, true, NULL,
                                  1, skey);
      ...
      if (OidIsValid(defacl->defaclnamespace)) {
        appendStringInfo(&buffer, _(" in schema %s"),
    ...
    case OCLASS_EVENT_TRIGGER: {
      ...
      tup =
          SearchSysCache1(EVENTTRIGGEROID, ObjectIdGetDatum(object->objectId));
      if (!HeapTupleIsValid(tup))
        elog(ERROR, "cache lookup failed for event trigger %u",
             object->objectId);
      appendStringInfo(
          &buffer, _("event trigger %s"),
    ...
    case OCLASS_POLICY: {
      ...
      sscan =
          systable_beginscan(policy_rel, PolicyOidIndexId, true, NULL, 1, skey);

      tuple = systable_getnext(sscan);

      if (!HeapTupleIsValid(tuple))
        elog(ERROR, "cache lookup failed for policy %u", object->objectId);
    ...
    default:
      appendStringInfo(&buffer, "unrecognized object %u %u %d", object->classId,
...
static void getOpFamilyDescription(StringInfo buffer, Oid opfid) {
  ...
  appendStringInfo(
      buffer, _("operator___ family %s for access method %s"),
...
Datum pg_describe_object(PG_FUNCTION_ARGS) {
  ...
  if (!OidIsValid(classid) && !OidIsValid(objid)) PG_RETURN_NULL();
  ...
  if (is_objectclass_supported(address.classId)) {
    ...
    if (objtup != NULL) {
      ...
      if (nspAttnum != InvalidAttrNumber) {
        schema_oid =
            heap_getattr(objtup, nspAttnum, RelationGetDescr(catalog), &isnull);
        if (isnull)
      ...
      if (get_object_namensp_unique(address.classId)) {
        ...
        if (nameAttnum != InvalidAttrNumber) {
          ...
          if (isnull)
            elog(ERROR, "invalid null name in object %u/%u/%d", address.classId,
...
Datum pg_identify_object_as_address(PG_FUNCTION_ARGS) {
  ...
  tupdesc = CreateTemplateTupleDesc(3, false);
  TupleDescInitEntry(tupdesc, (AttrNumber)1, "type", TEXTOID, -1, 0);
  TupleDescInitEntry(tupdesc, (AttrNumber)2, "object_names", TEXTARRAYOID, -1,
                     0);
  TupleDescInitEntry(tupdesc, (AttrNumber)3, "object_args", TEXTARRAYOID, -1,
                     0);
...
static void getRelationTypeDescription(StringInfo buffer, Oid relid,
  ...
  if (objectSubId != 0) appendStringInfoString(buffer, " column");
 ...
 */
char *getObjectIdentityParts(const ObjectAddress *object, List **objname,
                             List **objargs) {
  StringInfoData buffer;
  ...
  switch (getObjectClass(object)) {
    case OCLASS_CLASS:
      ...
      if (object->objectSubId != 0) {
        ...
        attr = get_relid_attribute_name(object->objectId, object->objectSubId);
        appendStringInfo(&buffer, ".%s", quote_identifier(attr));
        if (objname) *objname = lappend(*objname, attr);
      }
      break;
    ...
    case OCLASS_PROC:
      ...
      if (objname) format_procedure_parts(object->objectId, objname, objargs);
      break;
    ...
    case OCLASS_COLLATION: {
      ...
      appendStringInfoString(
          &buffer, quote_qualified_identifier(schema, NameStr(coll->collname)));
      if (objname)
    ...
    case OCLASS_CONVERSION: {
      ...
      appendStringInfoString(&buffer, quote_qualified_identifier(
                                          schema, NameStr(conForm->conname)));
      if (objname)
    ...
    case OCLASS_DEFAULT: {
      ...
      appendStringInfo(&buffer, "for %s",
                       getObjectIdentityParts(&colobject, objname, objargs));
    ...
    case OCLASS_OPERATOR:
      ...
      if (objname) format_operator_parts(object->objectId, objname, objargs);
      break;
    ...
    case OCLASS_OPCLASS: {
      ...
      appendStringInfo(
          &buffer, "%s USING %s",
          quote_qualified_identifier(schema, NameStr(opcForm->opcname)),
          quote_identifier(NameStr(amForm->amname)));
      if (objname)
        *objname = list_make3(pstrdup(NameStr(amForm->amname)), schema,
    ...
    case OCLASS_AMOP: {
      ...
      appendStringInfo(&buffer, "operator___ %d (%s, %s) of %s",
                       amopForm->amopstrategy, ltype, rtype, opfam.data);
    ...
    case OCLASS_AMPROC: {
      ...
      appendStringInfo(&buffer, "function %d (%s, %s) of %s",
                       amprocForm->amprocnum, ltype, rtype, opfam.data);
    ...
    case OCLASS_TRIGGER: {
      ...
      if (objname) *objname = lappend(*objname, pstrdup(NameStr(trig->tgname)));
    ...
    case OCLASS_TSPARSER: {
      ...
      appendStringInfoString(
          &buffer,
          quote_qualified_identifier(schema, NameStr(formParser->prsname)));
      if (objname)
    ...
    case OCLASS_TSDICT: {
      ...
      appendStringInfoString(&buffer, quote_qualified_identifier(
                                          schema, NameStr(formDict->dictname)));
      if (objname)
    ...
    case OCLASS_TSTEMPLATE: {
      ...
      appendStringInfoString(&buffer, quote_qualified_identifier(
                                          schema, NameStr(formTmpl->tmplname)));
      if (objname)
    ...
    case OCLASS_TSCONFIG: {
      ...
      appendStringInfoString(&buffer, quote_qualified_identifier(
                                          schema, NameStr(formCfg->cfgname)));
      if (objname)
    ...
    case OCLASS_TBLSPACE: {
      ...
      if (!tblspace)
        elog(ERROR, "cache lookup failed for tablespace %u", object->objectId);
      if (objname) *objname = list_make1(tblspace);
    ...
    case OCLASS_FDW: {
      ...
      if (objname) *objname = list_make1(pstrdup(fdw->fdwname));
      break;
    }
    ...
    case OCLASS_FOREIGN_SERVER: {
      ...
      if (objname) *objname = list_make1(pstrdup(srv->servername));
      break;
    }
    ...
    case OCLASS_USER_MAPPING: {
      ...
      appendStringInfo(&buffer, "%s on server %s", quote_identifier(usename),
                       srv->servername);
      break;
    }
    ...
    case OCLASS_DEFACL: {
      ...
      if (objname) {
        *objname = list_make1(username);
        if (schema) *objname = lappend(*objname, schema);
    ...
    case OCLASS_EXTENSION: {
      ...
      if (objname) *objname = list_make1(extname);
      break;
    }
  ...
  if (objname && *objname == NIL)
    elog(ERROR,
         "requested object address for unsupported object class___ %d: text "
         "result \"%s\"",
...
static void getOpFamilyIdentity(StringInfo buffer, Oid opfid, List **objname) {
  ...
  if (objname)
    *objname = list_make3(pstrdup(NameStr(amForm->amname)), pstrdup(schema),
...
static void getRelationIdentity(StringInfo buffer, Oid relid, List **objname) {
  ...
  appendStringInfoString(
      buffer, quote_qualified_identifier(schema, NameStr(relForm->relname)));
  if (objname)
...
ArrayType *strlist_to_textarray(List *list) {
  ...
  memcxt = AllocSetContextCreate(
      CurrentMemoryContext, "strlist to array", ALLOCSET_DEFAULT_MINSIZE,
  ...
  arr = construct_array(datums, list_length(list), TEXTOID, -1, false, 'i');
