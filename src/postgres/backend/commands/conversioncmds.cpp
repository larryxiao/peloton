...
ObjectAddress CreateConversionCommand(CreateConversionStmt *stmt) {
  ...
  static const Oid funcargs[] = {INT4OID, INT4OID, CSTRINGOID, INTERNALOID,
                                 INT4OID};
  char result[1];
   ...
   */
  OidFunctionCall5(funcoid, Int32GetDatum(from_encoding),
                   Int32GetDatum(to_encoding), CStringGetDatum(""),
                   CStringGetDatum(result), Int32GetDatum(0));
