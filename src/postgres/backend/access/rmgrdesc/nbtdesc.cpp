...
void btree_desc(StringInfo buf, XLogReaderState *record) {
  ...
  switch (info) {
    ...
    case XLOG_BTREE_SPLIT_R_ROOT: {
      ...
      appendStringInfo(buf, "level %u, firstright %d", xlrec->level,
                       xlrec->firstright);
      break;
    }
    ...
    case XLOG_BTREE_MARK_PAGE_HALFDEAD: {
      ...
      appendStringInfo(buf, "topparent %u; leaf %u; left %u; right %u",
                       xlrec->topparent, xlrec->leafblk, xlrec->leftblk,
                       xlrec->rightblk);
      break;
    }
    ...
    case XLOG_BTREE_UNLINK_PAGE: {
      ...
      appendStringInfo(buf, "left %u; right %u; btpo_xact %u; ", xlrec->leftsib,
                       xlrec->rightsib, xlrec->btpo_xact);
