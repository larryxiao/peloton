...
void ParseCommitRecord(uint8 info, xl_xact_commit *xlrec,
...
void ParseAbortRecord(uint8 info, xl_xact_abort *xlrec,
...
static void xact_desc_commit(StringInfo buf, uint8 info, xl_xact_commit *xlrec,
