...
static const yytype_uint8 yytranslate[] = {
    ...
    25, 26, 2, 2, 27, 2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2, 24,
    2,  2,  2, 2, 2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2, 2,
    2,  2,  2, 2, 2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2, 2,
    2,  2,  2, 2, 2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2, 2,
    2,  2,  2, 2, 2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2,  2, 2,
...
static const yytype_uint16 yyrline[] = {
    0,   94,  94,  100, 101, 105, 106, 107, 108, 109, 110, 111, 118, 129,
    139, 142, 146, 151, 156, 161, 166, 171, 176, 185, 194, 207, 220, 235,
    250, 267, 268, 272, 275, 279, 287, 292, 293, 297, 301, 308, 315, 316};
#endif
...
static const char *const yytname[] = {
    ...
    "drop_replication_slot", "start_replication", "start_logical_replication",
    "timeline_history", "opt_physical", "opt_slot", "opt_timeline",
...
static const yytype_uint16 yytoknum[] = {
    ...
    269, 270, 271, 272, 273, 274, 275, 276, 277, 278, 59,  40,  41,  44};
#endif
...
static const yytype_int8 yypact[] = {
    0,   -20, -20, -6,  14,  15,  16,  20,  -2,  -20, -20, -20, -20, -20, -20,
    -20, -13, 19,  3,   -8,  -20, -20, -20, -20, -20, 22,  -20, -20, -20, 21,
    -20, -20, -20, 5,   -20, 23,  -20, 24,  -20, -20, 25,  10,  -20, 7,   28,
    -20, 30,  -20, -20, 32,  -11, -20, -20, -20, -20, 30,  -20};

/* YYDEFACT[STATE-NUM] -- Default reduction number in state STATE-NUM.
   Performed when YYTABLE does not specify something else to do.  Zero
   means the default is an error.  */
static const yytype_uint8 yydefact[] = {
    0,  15, 12, 32, 0,  0,  0, 0,  4,  5,  6,  9,  10, 7,  8,  11, 13, 0,  30,
    0,  25, 28, 1,  3,  2,  0, 17, 18, 20, 0,  19, 22, 14, 31, 29, 0,  23, 0,
    16, 21, 0,  34, 24, 36, 0, 26, 0,  27, 33, 41, 0,  37, 40, 39, 35, 0,  38};

/* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] = {-20, -20, -20, -20, -20, -20, -20,
                                      -20, -20, -20, -20, -20, -20, -20,
                                      -20, -20, -20, -20, -19, -20};

/* YYDEFGOTO[NTERM-NUM].  */
static const yytype_int8 yydefgoto[] = {-1, 7,  24, 8,  9,  10, 16, 32, 11, 12,
...
static const yytype_uint8 yytable[] = {
    25, 26, 27, 28, 29, 30, 31, 1,  2,  3,  4,  5,  6,  36, 37, 54, 55, 17, 19,
    20, 22, 21, 23, 33, 34, 38, 39, 40, 42, 41, 44, 43, 46, 48, 49, 52, 56};

static const yytype_uint8 yycheck[] = {
    13, 14, 15, 16, 17, 18, 19, 7, 8,  9, 10, 11, 12, 21, 22, 26, 27, 23, 4,
    4,  0,  5,  24, 4,  21, 3,  5, 22, 4, 6,  20, 6,  25, 5,  4,  3,  55};

/* YYSTOS[STATE-NUM] -- The (internal number of the) accessing
   symbol of state STATE-NUM.  */
static const yytype_uint8 yystos[] = {
    0, 7, 8,  9, 10, 11, 12, 29, 31, 32, 33, 36, 37, 38, 39, 40, 34, 23, 42,
    4, 4, 5,  0, 24, 30, 13, 14, 15, 16, 17, 18, 19, 35, 4,  21, 41, 21, 22,
    3, 5, 22, 6, 4,  6,  20, 43, 25, 44, 5,  4,  45, 46, 3,  47, 26, 27, 46};

/* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] = {0,  28, 29, 30, 30, 31, 31, 31, 31, 31, 31,
                                    31, 32, 33, 34, 34, 35, 35, 35, 35, 35, 35,
                                    35, 36, 36, 37, 38, 39, 40, 41, 41, 42, 42,
                                    43, 43, 44, 44, 45, 45, 46, 47, 47};

/* YYR2[YYN] -- Number of symbols on the right hand side of rule YYN.  */
static const yytype_uint8 yyr2[] = {0, 2, 2, 1, 0, 1, 1, 1, 1, 1, 1, 1, 1, 2,
                                    2, 0, 2, 1, 1, 1, 1, 2, 1, 3, 4, 2, 5, 6,
                                    2, 1, 0, 2, 0, 2, 0, 3, 0, 1, 3, 2, 1, 0};
...
#line 147 "repl_gram.y" /* yacc.c:1646  */
    {
      (yyval.defelt) = makeDefElem("label", (Node *)makeString((yyvsp[0].str)));
    }
...
#line 152 "repl_gram.y" /* yacc.c:1646  */
    {
      (yyval.defelt) = makeDefElem("progress", (Node *)makeInteger(TRUE));
    }
...
#line 157 "repl_gram.y" /* yacc.c:1646  */
    {
      (yyval.defelt) = makeDefElem("fast", (Node *)makeInteger(TRUE));
    }
...
#line 162 "repl_gram.y" /* yacc.c:1646  */
    {
      (yyval.defelt) = makeDefElem("wal", (Node *)makeInteger(TRUE));
    }
...
#line 167 "repl_gram.y" /* yacc.c:1646  */
    {
      (yyval.defelt) = makeDefElem("nowait", (Node *)makeInteger(TRUE));
    }
...
#line 172 "repl_gram.y" /* yacc.c:1646  */
    {
      (yyval.defelt) =
          makeDefElem("max_rate", (Node *)makeInteger((yyvsp[0].uintval)));
    }
...
#line 177 "repl_gram.y" /* yacc.c:1646  */
    {
      (yyval.defelt) = makeDefElem("tablespace_map", (Node *)makeInteger(TRUE));
    }
